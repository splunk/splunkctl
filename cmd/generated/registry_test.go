...
func TestRegistry_List(t *testing.T) {
	c, _ := newTLSTestServer(t, http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/services/data/inputs/registry" {
...
func TestRegistry_Enable(t *testing.T) {
	c, _ := newTLSTestServer(t, http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/services/data/inputs/registry/col1/enable" {
			t.Errorf("unexpected path: %s", r.URL.Path)
		}
		w.Header().Set("Content-Type", "application/json")
		json.NewEncoder(w).Encode(map[string]any{
	...
	results, err := c.Do(context.Background(), client.Request{
		Method: "POST",
		Path:   "/data/inputs/registry/col1/enable",
	})
	if err != nil {
		t.Fatal(err)
	}
...
func TestRegistry_Disable(t *testing.T) {
	c, _ := newTLSTestServer(t, http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/services/data/inputs/registry/col1/disable" {
			t.Errorf("unexpected path: %s", r.URL.Path)
		}
		w.Header().Set("Content-Type", "application/json")
		json.NewEncoder(w).Encode(map[string]any{
	...
	results, err := c.Do(context.Background(), client.Request{
		Method: "POST",
		Path:   "/data/inputs/registry/col1/disable",
	})
	if err != nil {
		t.Fatal(err)
	}
...
func TestRegistry_Reload(t *testing.T) {
	c, _ := newTLSTestServer(t, http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path != "/services/data/inputs/registry/_reload" {
			t.Errorf("unexpected path: %s", r.URL.Path)
		}
		w.Header().Set("Content-Type", "application/json")
		json.NewEncoder(w).Encode(map[string]any{
