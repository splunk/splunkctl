...
// GuidCmd is the top-level command for the guid object.
var GuidCmd = &cobra.Command{
	Use:   "guid",
	Short: "Manage guid resources",
}

var GuidShowCmd = &cobra.Command{
	Use:         "show",
	Short:       `show the guid of the box`,
	Annotations: map[string]string{"offline_ok": "true", "describe_path": "/server/info"},
...
func init() {
	GuidCmd.AddCommand(GuidShowCmd)
}
